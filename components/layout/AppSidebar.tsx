...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-[220px] shrink-0 flex-col border-r border-gray-200 bg-gray-0 overflow-y-auto">
      {/* Logo */}
      <div className="px-4 pt-4 pb-3 border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="font-semibold text-[13px] text-gray-900 leading-tight">World Dev Dashboard</div>
            <div className="text-[11px] text-gray-500 mt-0.5">Mini Apps Ecosystem</div>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 py-2">
        ...
        {[
          ...
          <a
            ...
            className="flex items-center mx-1.5 px-2.5 py-1.5 rounded-md text-[12px] text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors"
          >
            {link.label}
          </a>
        ))}
      ...
      <div className="px-4 py-3 border-t border-gray-200">
        ...
        <div className="text-[11px] text-gray-500 mt-0.5">Refreshes hourly</div>
      </div>
    </aside>
  )
}
